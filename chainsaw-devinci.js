...
//try changing burger menu logo
var logo_burger = document.createElement("img");
logo_burger.setAttribute("src", "https://github.com/Kaowarstail/effective-chainsaw-cours-git/blob/main/chainsaw-logo.png?raw=true")
var square_burger = document.getElementById(".container-fluid .");
square_burger.src = logo_burger;